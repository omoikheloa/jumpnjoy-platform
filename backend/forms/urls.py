...
router.register(r'marshal-checklists', MarshalChecklistViewSet, basename='marshalchecklist')
router.register(r'safety-checks', SafetyCheckViewSet, basename='safetycheck')
